    ...
    <v-container v-else class="" fluid fill-height>
      <v-row class="fill-height align-content-space-between justify-center">
        <v-col lg="6">
          ...
          <v-list class="list-pokemons" v-if="filterPokemons.length > 0">
          ...
          <error v-else @change="search = '';showFavorities = false"></error>

          <v-toolbar class="toolbar-nav" v-if="filterPokemons.length > 0">
            <v-btn
              @click="showFavorities = false"
              rounded
              dark
              :class="showFavorities ? 'text-capitalize btn-toolbar-nav' : 'text-capitalize btn-toolbar-nav active'"
            >
            ...
            <v-btn
              @click="showFavorities = true"
              rounded
              dark
              :class="showFavorities ? 'text-capitalize btn-toolbar-nav active' : 'text-capitalize btn-toolbar-nav'"
            >
              <v-icon>mdi-star</v-icon>
              Favorites
            </v-btn>
          ...
          <v-dialog v-model="dialog" width="500">
            <div class="modal__pokemon-img">
              <v-img
                height="220"
                src="@/assets/img/background-pokemons.png"
              ></v-img>
              <v-img
                widht="180"
                height="180"
                contain
                class="modal__pokemon-img-fixed"
